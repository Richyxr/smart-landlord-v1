    ...
    <div className="payment-evidence-container" style={{ display: 'flex', flexDirection: 'column', flex: 1, gap: isMobile ? '14px' : '20px', maxWidth: '100%', boxSizing: 'border-box' }}>
      ...
      <style>{`
        @media (max-width: 768px) {
          .reconciliation-desktop-stepper {
            display: none !important;
          }
          .reconciliation-mobile-flow {
      ...
      {shouldShowReconciliationTabs && (
        <div style={{ display: 'flex', borderBottom: '1px solid var(--border)', background: 'var(--bg-surface)', borderRadius: 'var(--radius-sm)', overflowX: 'auto', whiteSpace: 'nowrap', scrollbarWidth: 'none' }}>
          {[
      ...
      {activeSubTab === 'wizard' && (
        <React.Fragment>
          {/* DESKTOP WORKFLOW STEPPER (Visible only on desktop >=769px via CSS) */}
          <div className="card reconciliation-desktop-stepper" style={{ padding: '12px 16px', flexDirection: 'column', gap: '10px' }}>
          ...
          {/* 3. MOBILE RECONCILIATION FLOW CARD (Visible only on mobile <=768px via CSS) */}
          <div className="card reconciliation-mobile-flow" style={{ padding: '14px 16px', flexDirection: 'column', gap: '12px' }}>
